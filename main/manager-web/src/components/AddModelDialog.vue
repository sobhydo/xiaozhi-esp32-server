...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      // Validate that the model ID is not purely text or whitespace
    ...
    // Validate model ID: cannot be purely text or whitespace
    validateModelId(modelId) {
      ...
      // Check whether it is empty or only whitespace
      if (trimmedId === '') {
        return false;
      }
      
      // Check whether it contains letters only (purely text)
      if (/^[a-zA-Z]+$/.test(trimmedId)) {
        return false;
      }
      
      // Check whether it contains whitespace
      if (/\s/.test(trimmedId)) {
        return false;
      }
