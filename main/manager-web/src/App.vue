...
export default {
  ...
  mounted() {
    // If this is a mobile device and VUE_APP_H5_URL is set, redirect to the H5 page when both conditions are met
    ...
    if (this.isCDNEnabled) {
      // Add a global Alt+C shortcut to show the cache viewer
