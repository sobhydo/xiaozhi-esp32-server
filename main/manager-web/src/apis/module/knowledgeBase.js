...
export default {
  ...
  createKnowledgeBase(data, callback, errorCallback) {
    ...
    makeApiRequest({
      ...
      errorCallback: (err) => {
        console.error('Failed to create the knowledge base:', err);
        if (err.response) {
      ...
      errorMessage: 'Failed to create the knowledge base',
  ...
  deleteKnowledgeBases(ids, callback, errorCallback) {
    ...
    makeApiRequest({
      ...
      callback: callback,
      errorCallback: errorCallback,
      errorMessage: 'Failed to delete knowledge bases in bulk',
  ...
  listChunks(datasetId, documentId, params, callback, errorCallback) {
    ...
    // Add the keyword search parameter
    if (params.keywords) {
